...
namespace LactoBioticsSystem.Customer_Management
{
    public partial class CustomerUpdateForm : Form
    {
        ...
        private void PicboxCUclose_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        ...
        private void BtnUpdate_Click(object sender, EventArgs e)
        {
              try
            {
                ...
                {
                    db.spUpdateCustomer(int.Parse(lblCust_ID.Text), txtName.Text, txtTin.Text, txtAddress.Text, txtBstyle.Text, txtContact.Text, cmbuCType.Text, DateTime.Now);
                    txtName.Text = "";
                    txtAddress.Text = "";
                    txtContact.Text = "";
                    cmbuCType.Text = "";
